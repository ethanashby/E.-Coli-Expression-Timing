...
```{r Dispersion Simulations, cache=T, eval=TRUE, echo=FALSE}
###################################################################################################################
...
Times<-rep(c(0,15,30,45,60,75,90,105,120,135,150), each=3)
design_more_TPs<-data.frame(Sample=c("JH01_A01","JH01_A02", "JH01_A03", "JH01_A04", "JH01_A05", "JH01_A06", "JH01_A07", "JH01_A08", "JH01_A09", "JH01_A010","JH01_A011","JH01_B01","JH01_B02","JH01_B03", "JH01_B04","JH01_B05","JH01_B06","JH01_B07","JH01_B08","JH01_B09","JH01_B10","JH01_B11","JH01_C01","JH01_C02","JH01_C03","JH01_C04","JH01_C05","JH01_C06","JH01_C07","JH01_C08","JH01_C09","JH01_C010","JH01_C11" ), Condition=rep("case",33), Time=Times)
...
for (k in 1:length(genes)){
  ...
  #let's generate some sizeFactors
  size_facs<-rep(0,33)
  for (i in seq(1,33,2)){
    size_facs[i]<-sizeFactors(ecolidds)[grep("JH01", names(sizeFactors(ecolidds)))][(i+1)/2]
  }
  for (i in seq(2,33,2)){
    size_facs[i]<-rnorm(1, mean=mean(size_facs[i-1], size_facs[i+1]), sd=0.1)
  }
  names(size_facs)<-c("JH01_A01","JH01_A02", "JH01_A03", "JH01_A04", "JH01_A05", "JH01_A06", "JH01_A07", "JH01_A08", "JH01_A09", "JH01_A010","JH01_A011","JH01_B01","JH01_B02","JH01_B03", "JH01_B04","JH01_B05","JH01_B06","JH01_B07","JH01_B08","JH01_B09","JH01_B10","JH01_B11","JH01_C01","JH01_C02","JH01_C03","JH01_C04","JH01_C05","JH01_C06","JH01_C07","JH01_C08","JH01_C09","JH01_C010","JH01_C11" )
...
#generate simulated read count data for 100 trajectories w/ proper NB noise
differentially_expressed<-matrix(ncol=33, nrow=100)
for (i in 1:33){
  expressions<-c()
  expressions<-c(expressions, rnbinom(n=100, mu=repmeans[i], size=disp))
  differentially_expressed[,i]<-round(expressions*as.numeric(size_facs[i]))
...
plot_trajectories<-matrix(nrow=11, ncol=101)
rownames(plot_trajectories)<-unique(Times)
colnames(plot_trajectories)<-c("init", paste(rep("gene", 100), seq(1,100)))
plot_trajectories[,1]<-means
for (i in 1:100){
...
scores<-rep(cor(plot_trajectories, method="spearman")[,1], each=11)

counts_to_plot<-repmeans*size_facs
counts_to_plot<-rbind(counts_to_plot, differentially_expressed)
counts_to_plot<-as.data.frame(t(counts_to_plot))
counts_to_plot$time<-Times[1:33]
