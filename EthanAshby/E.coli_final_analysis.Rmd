...
In the first condition beta, t, h0, and h1 all appeared highly reproducible, as the initial parameter values were relatively central to the distributions of simulated values.
...
```{r}
ggplot(monoparamsdf, aes(x=t, y=log(h1-h0)))+geom_jitter()
```
