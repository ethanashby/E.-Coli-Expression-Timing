...
```{r, cache=TRUE, eval=T, echo=F, warning=FALSE, message=FALSE, results='hide', fig.keep='all'}
...
```{r, eval=T, echo=F, warning=FALSE, message=FALSE, results='hide', fig.keep='hide'}
#growth curve (log) mean density
ggplot(rposconc, aes(x=Time, y=log(meanDensity), color=Trial))+geom_point()+geom_smooth()+ggtitle("Log mean density of cultures")
```
