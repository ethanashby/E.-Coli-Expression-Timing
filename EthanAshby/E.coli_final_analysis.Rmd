...
```{r Overlay Trajectories and Relative mRNA plot, cache=TRUE, warning=FALSE, eval=TRUE, echo=FALSE, message=FALSE, results='hide', fig.keep='all'}
#####################
...
overlay_sigmoids(seq(50, 80, 1), median=TRUE)
```
