...
all_fuzzy <- c()
all_fuzzy$bio <- fuzzylist_bio
all_fuzzy$cell <- fuzzylist_cell
all_fuzzy$mol <- fuzzylist_mol
...
#f
for (i in 1:3){
fgsea_all_pos_fuzzy[[i]] = fgsea(pathways = all_fuzzy[[i]], stats = ranks_log.pos, minSize = 15,  nperm = 1000)
fgsea_all_neg_fuzzy[[i]] = fgsea(pathways = all_fuzzy[[i]], stats = ranks_log.neg, minSize = 15,  nperm = 1000)
fgsea_all_fuzzy[[i]] = fgsea(pathways = all_fuzzy[[i]], stats = ranks, minSize = 15,  nperm = 1000)
}
