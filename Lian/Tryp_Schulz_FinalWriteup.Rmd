...
tryp_DEGs_all_3_way <-unique(c(intersect(rownames(resSig_012),maSigProGenes), intersect(tryp_impulse$vecDEGenes,rownames(resSig_012)), intersect(maSigProGenes, tryp_impulse$vecDEGenes)))
write.csv(tryp_DEGs, "tryp_DEGs.csv")
tryp_DEGs_3_way <- intersect(intersect(rownames(resSig_012),maSigProGenes),tryp_impulse$vecDEGenes)
...
#DEGcounts
DEGcounts<-as.matrix(TBcounts[rownames(TBcounts) %in% tryp_DEGs_3_way_sig_df$gene,])
...
####################################################################################################
set1<-intersect(tryp_DEGs_3_way_sig_df$gene,maSigProGenes)
set2<-intersect(tryp_impulse$vecDEGenes,tryp_DEGs_3_way_sig_df$gene)
